...
function operateFormatter(value, row, index) {//赋予的参数
    return [
        '<a href="javascript:void(0);" class="btn btn-warning btn-xs" v-on:click="editRow(\'+row.userId+\')"><i class="icon-pencil icon-large"></i>修改</a>&nbsp;',
        '<a href="javascript:void(0);" class="btn btn-danger btn-xs" v-on:click=="deleteRow('+row.userId+')"><i class="icon-trash icon-large"></i>删除</a>&nbsp;'
    ].join('');
}